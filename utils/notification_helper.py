...
# async def comment_on_post(post_id: int, comment: CommentCreate, db: Session = Depends(get_db), current_user: UserDB = Depends(get_current_user)):
#     """User comments on a post."""
#     new_comment = CommentDB(post_id=post_id, user_id=current_user.id, content=comment.content)
#     db.add(new_comment)
#     db.commit()
...
#     if post:
#         await send_notification_to_user(post.user_id, f"{current_user.username} commented on your post.")
