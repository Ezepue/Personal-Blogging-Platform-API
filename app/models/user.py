...
from sqlalchemy import Column, Integer, String, Enum, Index, Text, Boolean, DateTime, ForeignKey
...
class UserDB(Base):
    ...
    # Community standing and profile curation.
    is_verified = Column(Boolean, default=False, nullable=False, server_default="false")
    # use_alter breaks the users<->articles FK cycle: the constraint is added
    # (and dropped) via ALTER after both tables exist.
    pinned_article_id = Column(
        Integer,
        ForeignKey("articles.id", ondelete="SET NULL", use_alter=True, name="fk_users_pinned_article"),
        nullable=True,
    )
    ...
    articles = relationship(
        ...
        passive_deletes=True, foreign_keys="ArticleDB.author_id",
    )
